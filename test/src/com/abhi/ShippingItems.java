 ...
 *       &lt;sequence>
 *         &lt;element ref="{FishbowlSDK}ShippingItem" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "ShippingItems")
public class ShippingItems {

    @XmlElement(name = "ShippingItem")
    protected List<ShippingItem> shippingItem;
    ...
    public List<ShippingItem> getShippingItem() {
        if (shippingItem == null) {
            shippingItem = new ArrayList<ShippingItem>();
        }
