 ...
 *       &lt;sequence>
 *         &lt;element ref="{FishbowlSDK}SerialNum" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "SerialNumList")
public class SerialNumList {

    @XmlElement(name = "SerialNum")
    protected List<SerialNum> serialNum;
    ...
    public List<SerialNum> getSerialNum() {
        if (serialNum == null) {
            serialNum = new ArrayList<SerialNum>();
        }
